"""
Django settings for withered_salad_dev_78062 project.
...
ROOT_URLCONF = 'withered_salad_dev_78062.urls'
...
WSGI_APPLICATION = 'withered_salad_dev_78062.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_salad_dev_78062 API",
    "DESCRIPTION": "API documentation for withered_salad_dev_78062 App",
    "VERSION": "v1",
}
