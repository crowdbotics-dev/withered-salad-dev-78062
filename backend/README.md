...
## Project Structure
    ...
    ├── withered_salad_dev_78062  # Django project configurations
...
1. Clone this repo and `cd withered_salad_dev_78062`
...
2. Clone this repo and `cd withered_salad_dev_78062`
